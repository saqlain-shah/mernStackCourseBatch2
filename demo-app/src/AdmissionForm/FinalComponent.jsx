...
const FinalComponent = () => {
  ...
  switch (step) {
    ...
    case 1:
      return <EducationBackground Props={handleEducationInfoSubmit} handlePrevStep={handlePrevStep} educationInfo={educationInfo} />;
    case 2:
      return <Declaration Props={handleDeclarationSubmit} handlePrevStep={handlePrevStep} />;
    case 3:
      return (
        <FormSummary
